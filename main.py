...
st.markdown("""
    <style>
    .stApp {
        background-image: url("http://assets.inarkansas.com/130006/138579-bank-overdraft-changes-to-welcome-mat-animation-illustration-shutterstock-954.gif");
...
with st.sidebar:
    menu = option_menu(
        ...
        ["Home", 
         ...
         "Contact / Feedback", 
         "Logout"],
        icons=["house", "folder", "bar-chart", "graph-up", "person", "info-circle", "envelope", "box-arrow-right"],
        menu_icon="cast",
        default_index=0,
        styles={
...
if menu == "Home":
    ...
    st.markdown(f"""
    ### 🔑 Logged In As:
    - Username: {list(st.session_state.users.keys())[0]}
